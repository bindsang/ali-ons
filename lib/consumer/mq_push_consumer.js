...
class MQPushConsumer extends ClientConfig {
  ...
  subscribe(subscribeOptions) {
    ...
    if (isOrder) {
      // TODO: this.consumeMessageService = new ConsumeMessageOrderlyService(this, handler);
    } else {
      this.consumeMessageService = new ConsumeMessageConcurrentlyService(this, handler);
    }
